      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className={`absolute -bottom-40 -left-40 w-80 h-80 rounded-full opacity-30 blur-3xl transition-all duration-500 ${
          isDarkMode 
            ...
            : 'bg-gradient-to-tr from-emerald-100 to-blue-100'
        }`}></div>
      </div>
          ...
          <div className="flex gap-3 mb-8">
            <div className="flex-1 relative">
              <input
                ...
                className={`w-full px-4 py-3.5 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400 transition-all duration-200 font-medium ${
                  isDarkMode
                    ? 'bg-slate-700/50 border border-slate-600 text-slate-200 placeholder-slate-400'
                    : 'bg-slate-50/50 border border-slate-200 text-slate-700 placeholder-slate-400'
                }`}
              />
            </div>
            <button
              onClick={addTodo}
              className={`px-6 py-3.5 text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all duration-200 font-semibold shadow-lg hover:shadow-xl active:scale-95 ${
                isDarkMode
                ...
                <div
                  ...
                  className={`group flex items-center gap-4 p-4 rounded-xl transition-all duration-200 ${
                    isDarkMode
                      ...
                      : 'bg-white/60 border border-slate-100 hover:bg-white/80 hover:border-slate-200'
                  }`}
                >
                  <div className="relative">
                    <input
                      ...
                      className={`w-5 h-5 text-blue-600 rounded-md focus:ring-blue-500/20 focus:ring-2 transition-all duration-200 cursor-pointer ${
                        isDarkMode
